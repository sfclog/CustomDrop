...
public class ChangeUsedItem implements Menu {
   ...
   public ChangeUsedItem(Player var1, Mob var2, Drop var3) {
      this.player = var1;
      this.mob = var2;
      this.drop = var3;
   }
   ...
   public Inventory getMenu() {
      ...
      for(int var2 = 0; var2 < 36; ++var2) {
         ...
         if (var3 != null && var3.getType() != Material.AIR) {
            ...
            var4.addAction(new OpenMenu(this.player, new DropConditions(this.player, this.mob, this.drop)));
      ...
      Utilities.AddBackItem(this.player, (Menu)(new DropConditions(this.player, this.mob, this.drop)), var1, 54);
