...
public class ChangeDrop implements Menu {
   ...
   public ChangeDrop(Player var1, Block var2, Drop var3) {
      this.player = var1;
      this.block = var2;
      this.drop = var3;
   }
   ...
   public Inventory getMenu() {
      ...
      for(int var2 = 0; var2 < 36; ++var2) {
         ...
         if (var3 != null && var3.getType() != Material.AIR) {
            ...
            var4.addAction(new OpenMenu(this.player, new DropSettings(this.player, this.block, this.drop)));
      ...
      Utilities.AddCornerInfo(var6, this.block, this.drop);
      return var6;
   }
}
