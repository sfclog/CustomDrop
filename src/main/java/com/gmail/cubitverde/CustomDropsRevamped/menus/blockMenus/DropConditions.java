...
public class DropConditions implements Menu {
   ...
   public DropConditions(Player var1, Block var2, Drop var3) {
      this.player = var1;
      this.block = var2;
      this.drop = var3;
   }
   ...
   public Inventory getMenu() {
      ...
      Icon var3 = new Icon(Utilities.CreateItem(Material.BLACK_STAINED_GLASS_PANE, " "));
      var1.put(10, var3);
      var1.put(19, var3);
      ...
      var3.addAction(new OpenMenu(this.player, new ChangeUsedItem(this.player, this.block, this.drop)));
      var1.put(11, var3);
      ...
      var3.addAction(new OpenMenu(this.player, new DropConditions(this.player, this.block, this.drop)));
      var1.put(20, var3);
      ...
      var3.addAction(new NewSpeaker(this.player, this.block, this.drop, "condPermission"));
      var1.put(13, var3);
      ...
      var3.addAction(new OpenMenu(this.player, new ConditionWorlds(this.player, this.block, this.drop), 1));
      var1.put(14, var3);
      ...
      var3.addAction(new NewSpeaker(this.player, this.block, this.drop, "condMinPlayers"));
      var1.put(15, var3);
      ...
      var3.addAction(new NewSpeaker(this.player, this.block, this.drop, "condMaxPlayers"));
      var1.put(16, var3);
      ...
      var3.addAction(new OpenMenu(this.player, new DropConditions(this.player, this.block, this.drop)));
      var1.put(25, var3);
      var3 = new Icon(Utilities.CreateItem(Material.GOLDEN_PICKAXE, ChatColor.GREEN + "Fortune modifier"));
      var1.put(28, var3);
      if (var2.getFortuneModifier()) {
         var3 = new Icon(Utilities.CreateItem(Material.LIME_CONCRETE, ChatColor.GREEN + "Fortune modifier enabled", ChatColor.DARK_GREEN + "Click to disable the fortune modifier."));
      } else {
         var3 = new Icon(Utilities.CreateItem(Material.RED_CONCRETE, ChatColor.RED + "Fortune modifier disabled", ChatColor.DARK_RED + "Click to enable the fortune modifier."));
      }

      var3.addAction(new ToggleBool(var2, "fortuneModifier"));
      var3.addAction(new OpenMenu(this.player, new DropConditions(this.player, this.block, this.drop)));
      var1.put(37, var3);
      var3 = new Icon(Utilities.CreateItem(Material.BLACK_STAINED_GLASS_PANE, " "));
      var1.put(29, var3);
      var1.put(38, var3);
      Utilities.AddBackItem(this.player, (Menu)(new DropSettings(this.player, this.block, this.drop)), var1, 54);
      Inventory var4 = Utilities.BuildInventory(this.player, var1, ChatColor.DARK_GREEN + "[Drop Conditions]", 54);
      Utilities.AddCornerInfo(var4, this.block, this.drop);
      return var4;
   }
}
